...
public class TaskTest {
    ...
    public void cubeMovingTest() {
        ...
        /*Assert.assertEquals(new Task.Cube.Color[]{
                Task.Cube.Color.W, Task.Cube.Color.W, Task.Cube.Color.B,
                Task.Cube.Color.W, Task.Cube.Color.W, Task.Cube.Color.B,
                Task.Cube.Color.W, Task.Cube.Color.W, Task.Cube.Color.B
        }, cube.white);
        Assert.assertEquals(new Task.Cube.Color[]{
                Task.Cube.Color.G, Task.Cube.Color.Y, Task.Cube.Color.Y,
                Task.Cube.Color.G, Task.Cube.Color.Y, Task.Cube.Color.Y,
                Task.Cube.Color.G, Task.Cube.Color.Y, Task.Cube.Color.Y
        }, cube.yellow);
        Assert.assertEquals(new Task.Cube.Color[]{
        ...
        Assert.assertEquals(new Task.Cube.Color[]{
                Task.Cube.Color.B, Task.Cube.Color.B, Task.Cube.Color.Y,
                Task.Cube.Color.B, Task.Cube.Color.B, Task.Cube.Color.Y,
                Task.Cube.Color.B, Task.Cube.Color.B, Task.Cube.Color.Y
        }, cube.blue);
        Assert.assertEquals(new Task.Cube.Color[]{
                Task.Cube.Color.G, Task.Cube.Color.G, Task.Cube.Color.W,
                Task.Cube.Color.G, Task.Cube.Color.G, Task.Cube.Color.W,
                Task.Cube.Color.G, Task.Cube.Color.G, Task.Cube.Color.W
        }, cube.green);*/
    }
